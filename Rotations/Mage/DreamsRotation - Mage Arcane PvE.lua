...
local items = {
    settingsfile = "DreamsRotation - Mage Arcane PvE.json",
    {
        type = "title",
        text = "|cffff6060DreamsRotation |cffffffff- Arcane Mage PvE",
    },
    {
        type = "separator",
    },
...
local function onload()
    ni.GUI.AddFrame("DreamsRotation - Mage Arcane PvE", items);
end

local function onunload()
    ni.GUI.DestroyFrame("DreamsRotation - Mage Arcane PvE");
end
...
ni.bootstrap.profile("DreamsRotation - Mage Arcane PvE", queue, abilities, onload, onunload)