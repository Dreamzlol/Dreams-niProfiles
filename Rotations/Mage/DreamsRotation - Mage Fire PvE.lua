...
local items = {
    settingsfile = "DreamsRotation - Fire Mage PvE.json",
    {
        type = "title",
        text = "|cffff6060DreamsRotation |cffffffff- Fire Mage PvE",
    },
    {
        type = "separator",
    },
...
local function onload()
    ni.GUI.AddFrame("DreamsRotation - Mage Fire PvE", items);
end

local function onunload()
    ni.GUI.DestroyFrame("DreamsRotation - Mage Fire PvE");
end
...
ni.bootstrap.profile("DreamsRotation - Mage Fire PvE", queue, abilities, onload, onunload)